...
Y.use('dd-plugin', 'dd-scroll', 'escape', function(Y){
    ...
    LogiXML.PopupPanel.rdShowPopupPanel = function(elePopupPanel) {
        ...
        Y.one('body').on('keydown', rdHidePopupPanelOnEscKeyPress);
        ...
        if (elePopupPanel.getAttribute("rdModal") == "True") {
            ...
            if (rdModalShade) {
                ...
                if (window.attachEvent) { //IE
                    ...
                    //rdModalShade.attachEvent("onkeypress", rdHidePopupPanelOnEscKeyPress);
                } else { //Mozilla                
                    ...
                    //rdModalShade.onkeydown = rdHidePopupPanelOnEscKeyPress;      
                }
            }
        }
...
function rdPositionPopupPanel(elePopupPanel){
    ...
    switch (sLocation.toLowerCase()) {
        ...
        case 'mouse':
            ...
            if(document.getElementById('rdFreeformLayout') == null){    //#17789.
