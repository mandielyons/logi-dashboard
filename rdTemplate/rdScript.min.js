...
YUI.add("waitpanel",function(e){var t="Please wait...";e.namespace("LogiXML").WaitPanel=e.Base.create("WaitPanel",e.Base,[],{initializer:function(t){this._intervalKey=0,this.initPageWaitFrames(),LogiXML.Ajax.AjaxTarget().on("reinitialize",this.initPageWaitFrames,this),e.Lang.isValue(e.LogiXML.Tabs)&&e.LogiXML.Tabs.prototype.TabsTarget().on("selectedTabChanged",this.initPageWaitFrames,this),document.body.insertBefore(e.Node.create("<div style=\"display: none; background-image: url('rdTemplate/rdWaitAll.gif')\" />").getDOMNode(),document.body.children[0])},createWaitContent:function(t,n,r,i,s){var o="rdTemplate/";i?o+="rdWait.gif":o+="rdWaitAll.gif";if(t.indexOf("\\x")!=-1||t.indexOf("%20")!=-1)t=t.replace(/\\x/g,"%"),t=e.HistoryHash.decode(t);var u="",a="";return e.Lang.isValue(s)&&(u="_"+s),a='style="',n==""&&(a+="background-color: #fff; border: 1px solid #000;"),a+='display: table;"',e.Node.create('<div id="rdWait'+u+'" '+a+' class="'+n+'" ><table><tr><td><div id="rdWaitImage" style="width: 32px; height: 32px; background-image: url('+o+'); background-position: 0px 0px;" ></div></td><td><span class="'+r+'" >'+t+"</td></table></span></div>")},showWaitPanel:function(n){if(this.isWaitCanceled())return;if(e.Cookie.exists("rdFileDownloadComplete")){e.Cookie.remove("rdFileDownloadComplete",{path:"/"});return}var r,i,s;n[0]!=""?r=n[0]:r=t,n[1]!=""?i=n[1]:i="",n[2]!=""?s=n[2]:s="",e.Lang.isValue(document.getElementById("rdWait"))||document.body.insertBefore(this.createWaitContent(r,i,s).getDOMNode(),document.body.children[0]),e.Lang.isValue(this._pnlWait)||(this._pnlWait=new e.Panel({srcNode:"#rdWait",zIndex:9300,centered:!0,modal:!0,render:!0,buttons:null})),this._pnlWait.show();var o=e.one(".yui3-widget-mask");o.transition({duration:.25,opacity:{value:.5,easing:"ease-in"}}),LogiXML.WaitPanel._loadingCounter=0;var u=function(){var t=LogiXML.WaitPanel._loadingCounter%60,n=document.getElementById("rdWaitImage"),r=-32*t;LogiXML.WaitPanel._loadingCounter++,n.style.backgroundPosition=r+"px 0px",e.Cookie.exists("rdFileDownloadComplete")&&(e.Cookie.remove("rdFileDownloadComplete",{path:"/"}),LogiXML.WaitPanel.pageWaitPanel.hideWaitPanel())};this._intervalKey=window.setInterval(u,30)},hideWaitPanel:function(){if(e.Lang.isValue(this._pnlWait)){this._pnlWait.hide();var t=document.getElementById("rdWait");t&&(t.parentElement.removeChild(t),this._pnlWait.destroy(),this._pnlWait=null),window.clearInterval(this._intervalKey)}},readyWait:function(){this.get("cancelStack").push(!1)},cancelWait:function(){var e=this.get("cancelStack");e[e.length-1]=!0},isWaitCanceled:function(){return this.get("cancelStack").pop()},showFrameWait:function(n){var r=n.getData("waitkey");if(n.getAttribute("src")==""&&e.Lang.isValue(r)){var i,s,o;n.getData("waitmessage")!=""?i=n.getData("waitmessage"):i=t,e.Lang.isValue(n.getData("waitclass"))?s=n.getData("waitclass"):s="",e.Lang.isValue(n.getData("waitcaptionclass"))?o=n.getData("waitcaptionclass"):o="",r=n.get("id")+"_"+r,e.Lang.isValue(document.getElementById("rdWait_"+r))||n.insertBefore(this.createWaitContent(i,s,o,!0,r),n),n.setStyle("display","none"),n.on("load",this.hideFrameWait),n.set("src",n.getData("hiddensource"))}},hideFrameWait:function(t){var n=t.target,r=n.previous();e.Lang.isValue(r)&&r.get("id").indexOf("rdWait")==0&&(n.previous().remove(),n.setStyle("display",""))},initPageWaitFrames:function(){e.each(e.all("iframe"),function(t){LogiXML.isNodeVisible(t)&&e.Lang.isValue(t.getData("waitkey"))&&this.showFrameWait(t);var n=t.previous();n!=null&&n._node!=null&&(n._node.nodeName=="DIV"||n._node.nodeName=="div")&&n._node.id.indexOf(!1)&&(n=n.previous(),n!=null&&n._node!=null&&(n._node.nodeName=="DIV"||n._node.nodeName=="div")&&n._node.id.indexOf(!1)&&n._node.parentNode.removeChild(n._node))},this)}},{NAME:"waitpanel",ATTRS:{cancelStack:{value:new Array}}})},"1.0.0",{requires:["base","panel","transition","cookie","history"]});
...
* rdScroll.js 
*/
function rdSetScroll(){var e=rdGetScrollVar("rdScrollX"),t=rdGetScrollVar("rdScrollY");(e>0||t>0)&&window.scrollTo(e,t)}function rdResetScroll(){window.parent&&window.parent.scrollTo&&window.parent.scrollTo(0,0)}function rdGetScroll(e){var t,n;return typeof window.pageXOffset!="undefined"?(t=window.pageXOffset,n=window.pageYOffset):!window.document.compatMode||window.document.compatMode=="BackCompat"?(t=window.document.body.scrollLeft,n=window.document.body.scrollTop):(t=window.document.documentElement.scrollLeft,n=window.document.documentElement.scrollTop),e=="y"?n:t}function rdGetScrollVar(e){var t=self.document.location.href;return t.indexOf(e)>=0?(t=t.substring(t.indexOf(e)+(e.length+1),t.length),t=t.substring(0,t.indexOf("&")>=0?t.indexOf("&"):t.length)):t="",unescape(t)};

/* 
* rdAnalysisChart/rdAcScript.js 
*/
function rdAcUpdateControls(bRefresh,sReport,sAcId,bInit){var eleBatchSelection=document.getElementById("rowBatchSelection_"+sAcId);!eleBatchSelection&&!bInit&&(bRefresh=!0);var sCurrChartType=document.getElementById("rdAcChartType_"+sAcId).value,sElementIDs=sAcId+",divAcControls_"+sAcId+",cellAcChart_"+sAcId,bForecast=!1;document.getElementById("rdAcForecastType_"+sAcId)!=null&&(bForecast=!0),ShowElement(this.id,"lblChartXLabelColumn_"+sAcId,"Hide"),ShowElement(this.id,"lblChartXAxisColumn_"+sAcId,"Hide"),ShowElement(this.id,"lblChartYDataColumn_"+sAcId,"Hide"),ShowElement(this.id,"lblChartYAxisColumn_"+sAcId,"Hide"),ShowElement(this.id,"lblChartSizeColumn_"+sAcId,"Hide"),ShowElement(this.id,"rdAcChartSizeAggrLabel_"+sAcId,"Hide"),ShowElement(this.id,"rowChartXColumn_"+sAcId,"Hide"),ShowElement(this.id,"rowChartCrosstabColumn_"+sAcId,"Hide"),ShowElement(this.id,"rdAcChartXLabelColumn_"+sAcId,"Hide"),ShowElement(this.id,"rdAcChartXDataColumn_"+sAcId,"Hide"),ShowElement(this.id,"rdAcChartYColumn_"+sAcId,"Hide"),ShowElement(this.id,"rdChartYShowValues_"+sAcId,"Hide"),ShowElement(this.id,"rdAcChartYAggrLabel_"+sAcId,"Hide"),ShowElement(this.id,"rdAcChartYAggrList_"+sAcId,"Hide"),ShowElement(this.id,"rowChartExtraDataColumn_"+sAcId,"Hide"),ShowElement(this.id,"rowChartExtraAggrList_"+sAcId,"Hide"),ShowElement(this.id,"rowChartForecast_"+sAcId,"Hide"),ShowElement(this.id,"rowChartOrientation_"+sAcId,"Hide"),ShowElement(this.id,"rowChartRelevance_"+sAcId,"Hide"),ShowElement(this.id,"rowGaugeType_"+sAcId,"Hide"),ShowElement(this.id,"rowGaugeMin_"+sAcId,"Hide"),ShowElement(this.id,"rowGaugeGoal1_"+sAcId,"Hide"),ShowElement(this.id,"rowGaugeGoal2_"+sAcId,"Hide"),ShowElement(this.id,"rowGaugeMax_"+sAcId,"Hide");var eleCrosstab=document.getElementById("rdAcChartCrosstabColumn_"+sAcId),sCrosstabColumn="";eleCrosstab&&(sCrosstabColumn=eleCrosstab.value);switch(sCurrChartType){case"Pie":case"Bar":ShowElement(this.id,"lblChartXLabelColumn_"+sAcId,"Show"),ShowElement(this.id,"lblChartYDataColumn_"+sAcId,"Show"),ShowElement(this.id,"rowChartXColumn_"+sAcId,"Show"),ShowElement(this.id,"rdAcChartXLabelColumn_"+sAcId,"Show"),ShowElement(this.id,"rdAcChartYColumn_"+sAcId,"Show"),ShowElement(this.id,"rdChartYShowValues_"+sAcId,"Show"),ShowElement(this.id,"rdAcChartYAggrLabel_"+sAcId,"Show"),ShowElement(this.id,"rdAcChartYAggrList_"+sAcId,"Show");if(sCurrChartType=="Bar"){ShowElement(this.id,"rowChartOrientation_"+sAcId,"Show");var eleCrosstabColumn=document.getElementById("rdAcChartCrosstabColumn_"+sAcId);eleCrosstabColumn&&eleCrosstabColumn.options.length>1&&(ShowElement(this.id,"rowChartCrosstabColumn_"+sAcId,"Show"),sCrosstabColumn==""?ShowElement(this.id,"rdAcStacking_"+sAcId,"Hide"):ShowElement(this.id,"rdAcStacking_"+sAcId,"Show"))}rdAcGetGroupByDateOperatorDiv(document.getElementById("rdAcChartXLabelColumn_"+sAcId).value,sAcId),sCurrChartType=="Pie"||sCurrChartType==""?(document.getElementById("rdAcChartsDateGroupBy_"+sAcId).style.display="none",document.getElementById("rdAcChartsDateGroupBy_"+sAcId+"-Caption").style.display="none",bForecast&&document.getElementById("rowChartForecast_"+sAcId)!=null&&rdAcHideForecast(sAcId)):bForecast&&(document.getElementById("rdAcForecastType_"+sAcId).style.display="",document.getElementById("rdAcChartForecastLabel_"+sAcId).style.display="",rdModifyTimeSeriesCycleLengthOptions(document.getElementById("rdAcChartsDateGroupBy_"+sAcId),sAcId),rdSetForecastOptions(document.getElementById("rdAcChartXLabelColumn_"+sAcId).value,sAcId),rdShowForecast(document.getElementById("rdAcChartXLabelColumn_"+sAcId).value,sAcId));var sLabelColumnn=document.getElementById("rdAcChartXLabelColumn_"+sAcId).value,sLabelColumnType=rdAcGetColumnDataType(sLabelColumnn,sAcId);if(sLabelColumnType=="Text")if(sCrosstabColumn==""||sCurrChartType=="Pie"){ShowElement(this.id,"rowChartRelevance_"+sAcId,"Show");var sRelevanceType=document.getElementById("rdAcRelevanceType_"+sAcId).value;sRelevanceType=="None"||sRelevanceType=="Automatic"?ShowElement(this.id,"rdAcRelevanceValue_"+sAcId,"Hide"):ShowElement(this.id,"rdAcRelevanceValue_"+sAcId,"Show")}break;case"Line":case"Spline":ShowElement(this.id,"lblChartXAxisColumn_"+sAcId,"Show"),ShowElement(this.id,"lblChartYAxisColumn_"+sAcId,"Show"),ShowElement(this.id,"rowChartXColumn_"+sAcId,"Show"),ShowElement(this.id,"rdAcChartXDataColumn_"+sAcId,"Show"),ShowElement(this.id,"rdAcChartYColumn_"+sAcId,"Show"),ShowElement(this.id,"rdChartYShowValues_"+sAcId,"Show"),rdAcSetAggrOptions(document.getElementById("rdAcChartXDataColumn_"+sAcId).value,sAcId);var sColumn=document.getElementById("rdAcChartXDataColumn_"+sAcId).value,sDataColumnType=rdAcGetColumnDataType(sColumn,sAcId);if(sCurrChartType=="Line"&&sDataColumnType.toLowerCase().indexOf("date")!=-1){var eleCrosstabColumn=document.getElementById("rdAcChartCrosstabColumn_"+sAcId);eleCrosstabColumn&&eleCrosstabColumn.options.length>1&&(ShowElement(this.id,"rowChartCrosstabColumn_"+sAcId,"Show"),sCrosstabColumn==""?ShowElement(this.id,"rdAcStacking_"+sAcId,"Hide"):ShowElement(this.id,"rdAcStacking_"+sAcId,"Show"))}bForecast&&(document.getElementById("rdAcForecastType_"+sAcId).style.display="",document.getElementById("rdAcChartForecastLabel_"+sAcId).style.display="",rdSetForecastOptions(document.getElementById("rdAcChartXDataColumn_"+sAcId).value,sAcId),rdModifyTimeSeriesCycleLengthOptions(document.getElementById("rdAcChartsDateGroupBy_"+sAcId),sAcId),rdShowForecast(sColumn,sAcId)),rdAcGetGroupByDateOperatorDiv(document.getElementById("rdAcChartXDataColumn_"+sAcId).value,sAcId);break;case"Scatter":ShowElement(this.id,"lblChartXAxisColumn_"+sAcId,"Show"),ShowElement(this.id,"lblChartYAxisColumn_"+sAcId,"Show"),ShowElement(this.id,"rowChartXColumn_"+sAcId,"Show"),ShowElement(this.id,"rdAcChartXDataColumn_"+sAcId,"Show"),ShowElement(this.id,"rdAcChartYColumn_"+sAcId,"Show"),ShowElement(this.id,"rdChartYShowValues_"+sAcId,"Show"),document.getElementById("rdAcChartsDateGroupBy_"+sAcId).style.display="none",document.getElementById("rdAcChartsDateGroupBy_"+sAcId+"-Caption").style.display="none";break;case"Heatmap":ShowElement(this.id,"lblChartXLabelColumn_"+sAcId,"Show"),ShowElement(this.id,"lblChartSizeColumn_"+sAcId,"Show"),ShowElement(this.id,"rdAcChartSizeAggrLabel_"+sAcId,"Show"),ShowElement(this.id,"rowChartXColumn_"+sAcId,"Show"),ShowElement(this.id,"rdAcChartXLabelColumn_"+sAcId,"Show"),ShowElement(this.id,"rdAcChartYColumn_"+sAcId,"Show"),ShowElement(this.id,"rdAcChartYAggrList_"+sAcId,"Show"),ShowElement(this.id,"rowChartExtraDataColumn_"+sAcId,"Show"),ShowElement(this.id,"rowChartExtraAggrList_"+sAcId,"Show"),document.getElementById("rdAcChartsDateGroupBy_"+sAcId).style.display="none",document.getElementById("rdAcChartsDateGroupBy_"+sAcId+"-Caption").style.display="none";break;case"Gauge":ShowElement(this.id,"lblChartYDataColumn_"+sAcId,"Show"),ShowElement(this.id,"rdAcChartYColumn_"+sAcId,"Show"),ShowElement(this.id,"rdAcChartYAggrLabel_"+sAcId,"Show"),ShowElement(this.id,"rdAcChartYAggrList_"+sAcId,"Show"),ShowElement(this.id,"rowGaugeType_"+sAcId,"Show"),ShowElement(this.id,"rowGaugeMin_"+sAcId,"Show"),ShowElement(this.id,"rowGaugeGoal1_"+sAcId,"Show"),ShowElement(this.id,"rowGaugeGoal2_"+sAcId,"Show"),ShowElement(this.id,"rowGaugeMax_"+sAcId,"Show")}var eleAggrSelect=document.getElementById("rdAcChartYAggrList_"+sAcId),sSelectedAggr=eleAggrSelect.value;if(sSelectedAggr=="MIN"||sSelectedAggr=="MAX")eleCrosstab.value=eleCrosstab.options[0].value,ShowElement(this.id,"rowChartCrosstabColumn_"+sAcId,"Hide");sCrosstabColumn!=""&&(sCurrChartType=="Bar"||sCurrChartType=="Line")&&rdAcHideForecast(sAcId);var eleShowValuesDropdown=document.getElementById("rdAcShowValues_"+sAcId);if(sCurrChartType=="Pie"){if(eleShowValuesDropdown.length<3&&eleShowValuesDropdown.hasAttribute("rdPercentageCaption")){var eleOptionPercentage=document.createElement("option");eleOptionPercentage.value=eleShowValuesDropdown.getAttribute("Percent"),eleOptionPercentage.text=eleShowValuesDropdown.getAttribute("rdPercentageCaption"),eleShowValuesDropdown.add(eleOptionPercentage)}}else eleShowValuesDropdown.length==3&&(eleShowValuesDropdown.setAttribute("rdPercentageCaption",eleShowValuesDropdown.options[2].text),eleShowValuesDropdown.options.remove(2));rdAcSetButtonStyle(sAcId,sCurrChartType,"Pie"),rdAcSetButtonStyle(sAcId,sCurrChartType,"Bar"),rdAcSetButtonStyle(sAcId,sCurrChartType,"Line"),rdAcSetButtonStyle(sAcId,sCurrChartType,"Spline"),rdAcSetButtonStyle(sAcId,sCurrChartType,"Scatter"),rdAcSetButtonStyle(sAcId,sCurrChartType,"Heatmap"),rdAcSetButtonStyle(sAcId,sCurrChartType,"Gauge"),rdAcLoadDropdowns(sCurrChartType,sAcId);if(bRefresh){sElementIDs+=",lblHeadingAnalChart_"+sAcId;var sAjaxUrl="rdAjaxCommand=RefreshElement&rdAcRefresh=True&rdRefreshElementID="+sElementIDs+"&rdReport="+sReport+"&rdAcId="+sAcId;sAjaxUrl+="&rdAcNewCommand=True";var waitCfg=["","",""],eleWaitCfg=document.getElementById("rdWaitCfg");if(eleWaitCfg)try{var sScript=eleWaitCfg.parentElement.href;sScript=sScript.substr(sScript.indexOf("[")),waitCfg=eval(sScript.substr(0,sScript.indexOf("]")+1))}catch(e){}rdAjaxRequestWithFormVars(sAjaxUrl,"false","",!0,null,null,waitCfg)}}function rdAcShowAddToDashboard(e){if(typeof LogiXML.AnalysisGrid.rdAgToggleChartPanel=="function"){var t=document.getElementById("colAnalChartAddDashboard_"+e);t&&(t.style.display="")}else{var t=document.getElementById("divAddToDashboardPanel_"+e);t&&(t.style.display="")}}function rdAcLoadDropdowns(e,t){e=="Pie"||e=="Heatmap"?rdAcSetDropdownColumns(t,"rdAcChartXLabelColumn","Text,Boolean"):rdAcSetDropdownColumns(t,"rdAcChartXLabelColumn","Text,Date,DateTime,Boolean"),e=="Line"||e=="Spline"||e=="Scatter"?rdAcSetDropdownColumns(t,"rdAcChartYColumn","Number"):rdAcSetDropdownColumns(t,"rdAcChartYColumn","Text,Number"),rdAcSetDropdownAggrs(t,"rdAcChartYAggrList","rdAcChartYColumn"),rdAcSetDropdownAggrs(t,"rdAcChartExtraAggrList","rdAcChartExtraDataColumn")}function rdAcSetDropdownColumns(e,t,n){var r=document.getElementById(t+"_"+e),i=r.value;for(var s=r.childNodes.length-1;s>=0;s--){var o=r.childNodes[s];o.tagName=="OPTION"&&r.removeChild(o)}var u=document.getElementById("rdAcAllColumnsHidden_"+e);for(var s=0;s<u.childNodes.length;s++){var o=u.childNodes[s];if(o.tagName=="OPTION"){var a=rdAcGetColumnDataType(o.value,e);n.indexOf(a)!=-1&&r.appendChild(o.cloneNode(!0))}}r.value=i,r.value==""&&r.options[0]&&(r.value=r.options[0].value)}function rdAcSetDropdownAggrs(e,t,n){var r=document.getElementById(t+"_"+e),i=r.value;for(var s=r.childNodes.length-1;s>=0;s--){var o=r.childNodes[s];o.tagName=="OPTION"&&r.removeChild(o)}var u=document.getElementById(n+"_"+e),a=rdAcGetColumnDataType(u.value,e),f=document.getElementById("rdAcAllAggrsHidden_"+e);for(var s=0;s<f.childNodes.length;s++){var o=f.childNodes[s];o.tagName=="OPTION"&&(a=="Number"||o.value.toLowerCase().indexOf("count")!=-1)&&r.appendChild(o.cloneNode(!0))}r.value=i,r.value==""&&(r.value=r.options[0].value)}function rdAcSetButtonStyle(e,t,n){var r=document.getElementById("lblChart"+n+"_"+e);if(r){n==t?r.className="rdAcCommandHighlight":r.className="rdAcCommandIdle";var i=!1;r.parentNode.nextSibling.tagName=="A"&&r.parentNode.previousSibling.id.indexOf("actionShow")!=0&&(r.className=r.className+" rdAcCommandLeft",i=!0),r.parentNode.previousSibling.tagName=="A"&&r.parentNode.nextSibling.id.indexOf("actionShow")!=0&&(r.className=r.className+" rdAcCommandRight",i=!0),i||(r.className=r.className+" rdAcCommandMiddle")}}function rdShowForecast(e,t){if(document.getElementById("rdAcForecastType_"+t)==null)return;var n=rdAcGetColumnDataType(e,t);if(n.toLowerCase()=="text"||n.toLowerCase()=="boolean"){rdAcHideForecast();return}ShowElement(this.id,"rowChartForecast_"+t,"Show");var r=document.getElementById("rdAcForecastType_"+t);if(r.value=="TimeSeriesDecomposition"){document.getElementById("rdAcChartsDateGroupBy_"+t).value=="FirstDayOfYear"?(document.getElementById("rdAcTimeSeriesCycle_"+t).style.display="none",document.getElementById("rdAcTimeSeriesCycle_"+t+"-Caption").style.display="none"):(document.getElementById("rdAcTimeSeriesCycle_"+t).style.display="",document.getElementById("rdAcTimeSeriesCycle_"+t+"-Caption").style.display=""),document.getElementById("rdAcRegressionType_"+t).style.display="none",document.getElementById("rdAcRegressionType_"+t+"-Caption").style.display="none";return}if(r.value=="Regression"){var i=document.getElementById("rdAcRegressionType_"+t);document.getElementById("rdAcRegressionType_"+t).style.display="",document.getElementById("rdAcRegressionType_"+t+"-Caption").style.display="",document.getElementById("rdAcTimeSeriesCycle_"+t).style.display="none",document.getElementById("rdAcTimeSeriesCycle_"+t+"-Caption").style.display="none";return}document.getElementById("rdAcTimeSeriesCycle_"+t).style.display="none",document.getElementById("rdAcTimeSeriesCycle_"+t+"-Caption").style.display="none",document.getElementById("rdAcRegressionType_"+t).style.display="none",document.getElementById("rdAcRegressionType_"+t+"-Caption").style.display="none"}function rdAcHideForecast(e){if(document.getElementById("rdAcForecastType_"+e)==null)return;document.getElementById("rowChartForecast_"+e).style.display="none",document.getElementById("rdAcForecastType_"+e).style.display="none",document.getElementById("rdAcChartForecastLabel_"+e).style.display="none",document.getElementById("rdAcTimeSeriesCycle_"+e).style.display="none",document.getElementById("rdAcTimeSeriesCycle_"+e+"-Caption").style.display="none",document.getElementById("rdAcRegressionType_"+e).style.display="none",document.getElementById("rdAcRegressionType_"+e+"-Caption").style.display="none"}function rdAcSetAggrOptions(e,t){if(document.getElementById("rdAcChartType_"+t).value!="Line"&&document.getElementById("rdAcChartType_"+t).value!="Spline")return;if(e==""){document.getElementById("rowChartYAggr_"+t).style.display="none";return}var n=rdAcGetColumnDataType(e,t);n.toLowerCase()=="number"?(ShowElement(this.id,"rdAcChartYAggrLabel_"+t,"Hide"),ShowElement(this.id,"rdAcChartYAggrList_"+t,"Hide")):(ShowElement(this.id,"rdAcChartYAggrLabel_"+t,"Show"),ShowElement(this.id,"rdAcChartYAggrList_"+t,"Show"))}function rdSetForecastOptions(e,t){if(document.getElementById("rdAcForecastType_"+t)==null)return;if(e=="")return;var n=document.getElementById("rdAcForecastType_"+t),r=n.value,i=document.getElementById("rdAcChartsDateGroupBy_"+t),s=["None","TimeSeriesDecomposition","Regression"],o=["","Time Series","Regression"],u=rdAcGetColumnDataType(e,t);if(u.toLowerCase()=="text"||u.toLowerCase()=="boolean"){rdAcHideForecast(t);return}if(u.toLowerCase()!="date"&&u.toLowerCase()!="datetime")n.options[1].value=="TimeSeriesDecomposition"&&(n.remove(1),document.getElementById("rdAcTimeSeriesCycle_"+t).style.display="none");else if(n.options.length<3){var a;for(a=0;a<4;a++)n.options.length>0&&n.remove(0);var f;for(f=0;f<o.length;f++){var l=document.createElement("option");l.text=o[f],l.value=s[f],n.add(l)}r.length>0&&(n.value=r);return}}function rdResetOrientation(e){var t=document.getElementById("rdAcOrientation_"+e);if(t==null)return;var n=document.getElementById("rdAcChartXLabelColumn_"+e);if(n==null)return;var r=rdAcGetColumnDataType(n.value,e);r.toLowerCase()=="date"||r.toLowerCase()=="datetime"?t.value="Vertical":t.value="Horizontal"}function rdAcGetColumnDataType(e,t){var n=document.getElementById("rdAcDataColumnDetails_"+t);if(n.value!=""){var r=n.value,i=r.split(",");if(i.length>0){var s;for(s=0;s<i.length;s++){var o=i[s];if(o.length>1&&o.indexOf(":")>-1){var u=o.split(":")[0];if(u==e)return o.split(":")[1]}}}}}function rdModifyTimeSeriesCycleLengthOptions(e,t){if(document.getElementById("rdAcForecastType_"+t)==null)return;var n=document.getElementById("rdAcTimeSeriesCycle_"+t),r=n.value,i=e.value,s,o=0,u=["Year","Quarter","Month","Week","Day","Hour"];rdResetTimeSeriesCycleLenthDropdown(t);switch(i){case"FirstDayOfYear":for(s=0;s<7;s++){var a=n.options[o];a!=null&&(a.value!=""?n.remove(o):(a.value==r&&(n.value=r),o+=1))}document.getElementById("rdAcTimeSeriesCycle_"+t).style.display="none",document.getElementById("rdAcTimeSeriesCycle_"+t+"-Caption").style.display="none";break;case"FirstDayOfQuarter":for(s=0;s<7;s++){var a=n.options[o];a!=null&&(a.value!=""&&a.value!="Year"?n.remove(o):(a.value==r&&(n.value=r),o+=1))}document.getElementById("rdAcForecastType_"+t).value=="TimeSeriesDecomposition"&&(document.getElementById("rdAcTimeSeriesCycle_"+t).style.display="",document.getElementById("rdAcTimeSeriesCycle_"+t+"-Caption").style.display="");break;case"FirstDayOfMonth":for(s=0;s<7;s++){var a=n.options[o];a!=null&&(a.value!=""&&a.value!="Year"&&a.value!="Quarter"?n.remove(o):(a.value==r&&(n.value=r),o+=1))}document.getElementById("rdAcForecastType_"+t).value=="TimeSeriesDecomposition"&&(document.getElementById("rdAcTimeSeriesCycle_"+t).style.display="",document.getElementById("rdAcTimeSeriesCycle_"+t+"-Caption").style.display="");break;case"Date":case"DateTime":for(s=0;s<7;s++){var a=n.options[o];a!=null&&(a.value!=""&&a.value!="Year"&&a.value!="Quarter"&&a.value!="Month"&&a.value!="Week"?n.remove(o):(a.value==r&&(n.value=r),o+=1))}document.getElementById("rdAcForecastType_"+t).value=="TimeSeriesDecomposition"&&(document.getElementById("rdAcTimeSeriesCycle_"+t).style.display="",document.getElementById("rdAcTimeSeriesCycle_"+t+"-Caption").style.display="")}n.value==""&&(n.value=n.options[n.options.length-1].value,n.options[n.options.length-1].value=="Day"&&(n.value=""))}function rdResetTimeSeriesCycleLenthDropdown(e){if(document.getElementById("rdAcForecastType_"+e)==null)return;var t=document.getElementById("rdAcTimeSeriesCycle_"+e),n,r=["","Year","Quarter","Month","Week","Day"];if(t.options.length>5)return;for(n=0;n<7;n++){if(!(t.options.length>0))break;t.remove(0)}for(n=0;n<r.length;n++){var i=document.createElement("option");i.text=r[n],i.value=r[n],t.add(i)}}function rdAcGetGroupByDateOperatorDiv(e,t){typeof e=="undefined"&&(document.getElementById("rdAcChartsDateGroupBy_"+t).style.display="none",document.getElementById("rdAcChartsDateGroupBy_"+t+"-Caption").style.display="none");var n=document.getElementById("rdAcPickDateColumnsForGrouping_"+t);n!=null?n.value.length>0?n.value.indexOf(e)>-1?(document.getElementById("rdAcChartsDateGroupBy_"+t).style.display="",document.getElementById("rdAcChartsDateGroupBy_"+t+"-Caption").style.display=""):(document.getElementById("rdAcChartsDateGroupBy_"+t).style.display="none",document.getElementById("rdAcChartsDateGroupBy_"+t+"-Caption").style.display="none"):(document.getElementById("rdAcChartsDateGroupBy_"+t).style.display="none",document.getElementById("rdAcChartsDateGroupBy_"+t+"-Caption").style.display="none"):(document.getElementById("rdAcChartsDateGroupBy_"+t).style.display="none",document.getElementById("rdAcChartsDateGroupBy_"+t+"-Caption").style.display="none")};
...
*/
YUI.add("rdLogiVisualization",function(e){var t=e.Lang,n="rdLogiVisualization";LogiXML.Ajax.AjaxTarget&&LogiXML.Ajax.AjaxTarget().on("reinitialize",function(){e.LogiXML.rdLogiVisualization.createElements(!0)}),e.LogiXML.Node.destroyClassKeys.push(n),e.namespace("LogiXML").rdLogiVisualization=e.Base.create("rdLogiVisualization",e.Base,[],{id:null,configNode:null,initializer:function(e){this._parseHTMLConfig(),this.configNode.setData(n,this)},_parseHTMLConfig:function(){this.configNode=this.get("configNode"),this.id=this.configNode.getAttribute("id")},destructor:function(){var e=this.configNode,t=$("#"+this.id+" div");if(t){var r=t.children().scope();r&&r.$destroy()}e.setData(n,null)}},{NAME:"rdLogiVisualization",ATTRS:{configNode:{value:null,setter:e.one}},createElements:function(t){var r;e.all("."+n).each(function(i){r=i.getData(n),r||(r=new e.LogiXML.rdLogiVisualization({configNode:i}),t&&e.LogiXML.rdLogiVisualization.createVisualization(i))})},createVisualization:function(e){var t=e.one("logi-visualization,logi-crosstab-table");if(!t)return;var n=t.get("parentNode"),r=t.getAttribute("dataview"),i=window[r],s=t.getAttribute("config");e.setAttribute("config",s);var o=window[s];o.dataview=i,t.remove();var u=window.Logi;o&&o.id&&delete o.id;if(u&&u.Platform)var a=u.Platform.select("#"+n.getAttribute("id")).append(o)},visualizationRendered:function(t){var n=e.one("#"+t);if(n)if(n.hasClass("rdBrowserBorn"))n.setAttribute("data-rdBrowserBornReady","true");else{var r=n.ancestor(".rdBrowserBorn");r&&r.setAttribute("data-rdBrowserBornReady","true")}},resize:function(e,t,n,r,i){r!="%"?e.setStyle("width",t-25+"px"):e.setStyle("width",t+r),i!="%"&&e.setStyle("height",n+"px");var s=window.Logi,o,u,a;a=e.getAttribute("id");if(!a||a=="")return;s&&s.Platform&&(o=Logi.Platform.select("#"+a),o&&o.config&&(u=o.config()));if(!u){var f=e.get("parentNode").getAttribute("config");u=window[f]}if(!u){var f=e.getAttribute("config");u=window[f]}if(u&&u.style)if(u.type==="visualization"){if(u.style.width=="100%"&&u.style.height=="100%")return;u.style.width="100%",u.style.height="100%"}else u.style.width="100%",u.style.height=n+"px";o&&o.config&&o.config(u)}})},"1.0.0",{requires:["base","node","event","node-custom-destroy","event-custom"]});
