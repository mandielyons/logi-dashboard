...
* rdIFrameResize.js 
*/
function canAccessIFrame(e){var t=null;try{var n=e.contentDocument||e.contentWindow.document;t=n.body.innerHTML}catch(r){}return t!==null}function iframeResize(e,t){if(e.src!=""){if(e.contentWindow===null)return;var n=canAccessIFrame(e),r=Y.one(e);if(n)var i=Y.one(e.contentWindow.document),s=i.one("body"),o=i.one("html"),u,a,f,l;r.setStyle("display",""),r.setStyle("overflow","hidden");if(n){if(s.get("scrollWidth")==0&&s.get("scrollHeight")==0)return;o.setStyles({margin:0,width:"100%",height:"100%"}),s.setStyles({margin:0,width:"100%",height:"100%"})}var c=document.documentElement.scrollTop>document.body.scrollTop?document.documentElement.scrollTop:document.body.scrollTop,h=document.documentElement.scrollLeft>document.body.scrollLeft?document.documentElement.scrollLeft:document.body.scrollLeft;f=r.getAttribute("rdIFrameFixedWidth"),l=r.getAttribute("rdIFrameFixedHeight"),f=Y.Lang.isString(f)?f.toLowerCase()==="true"?!0:!1:!1,l=Y.Lang.isString(l)?l.toLowerCase()==="true"?!0:!1:!1;if(f){e.style.width=e.width;switch(r.getAttribute("Scrolling")){case"yes":r.setStyles({overflowX:"visible"});break;case"no":r.setStyles({overflowX:"hidden"});break;default:r.setStyles({overflowX:"auto"})}}else u=n?o.get("scrollWidth"):400,e.style.width=u+"px",e.width=u+"px";if(l){e.style.height=e.height;if(!f&&o.get("scrollHeight")>o.get("offsetHeight")){r.setStyles({overflowY:"scroll",overflowX:"hidden"});var p=o.get("scrollWidth")-o.get("clientWidth")+r.get("scrollWidth");e.style.width=p+"px",e.width=p+"px"}}else n?(e.style.height="1px",e.height="1px",a=o.get("scrollHeight"),s.get("scrollHeight")>o.get("scrollHeight")&&a==1&&(a=s.get("scrollHeight")),e.style.height="",e.height="",e.style.height=a+"px",e.height=a+"px"):(e.style.height="1px",e.height="1px",a=400,e.style.height=a+"px",e.height=a+"px");window.scrollTo(h,c)}rdCheckForAPopupPanelParent(e),Y.Lang.isValue(frameElement)&&Y.Lang.isFunction(window.parent.iframeResize)&&window.parent.iframeResize(frameElement);var d=Y.namespace("LogiXML.Dashboard.FreeForm");d&&Y.Lang.isFunction(d.rdResizeDashboardContainer)&&d.rdResizeDashboardContainer()}function rdCheckForAPopupPanelParent(e){try{if(!e)return;var t=e.parentNode;while(t){if(Y.Lang.isValue(t.attributes)&&t.attributes.rdPopupPanel){rdPositionPopupPanel(t);return}t=t.parentNode}}catch(n){}};
